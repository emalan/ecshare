...
@Component()
public class MemberSpringDao extends AbstractSpringDao implements MemberDao{

	private static final Logger log = LoggerFactory.getLogger(MemberSpringDao.class);
