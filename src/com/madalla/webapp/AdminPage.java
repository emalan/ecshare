...
public abstract class AdminPage extends WebPage {
	...
	protected void setupMenu(){
		add(new LinkLoginAware("UserProfile", UserProfilePage.class, false).setAutoEnable(true));
		add(new LinkLoginAware("SiteAdmin", SiteAdminPage.class, true).setAutoEnable(true));
		add(new LinkLoginAware("Data", SiteDataPage.class, true).setAutoEnable(true));
		add(new LinkLoginAware("Content", ContentAdminPage.class, true).setAutoEnable(true));
