...
public class ImageData  implements IRepositoryData, Serializable, Comparable<ImageData> {
	...
	ImageData(final String album, final String name, final InputStream fullImage){
		this.id = "";
		this.album = album;
		this.name = name;
	...
	ImageData(final String id, final String album, final String name, final DynamicImageResource fullImage){
		this.id = id;
		this.album = album;
		this.name = name;
		this.fullImage = null;
	...
	public DynamicImageResource getThumbnail() {
		return thumbnail;
	}

	public void setThumbnail(DynamicImageResource thumbnail) {
